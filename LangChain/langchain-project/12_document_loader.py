...
# Save the document
with open('c://GCP//GenAILearnings//LangChain//langchain-project//data//knowledge_base.txt', 'w') as f:
    f.write(knowledge_doc)

# Load the document using modern LangChain
loader = TextLoader('c://GCP//GenAILearnings//LangChain//langchain-project//data//knowledge_base.txt')
...
with open('c://GCP//GenAILearnings//LangChain//langchain-project//data//doc-loading.txt', 'w') as f:
